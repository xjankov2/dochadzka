...
@Component({
  ...
  <div tabindex="0"
    ...
    <input type="text" autocomplete="false" tabindex="-1"
     ...
     <!-- options template -->
     <ul *ngIf="optionsOpened && !firstItemHasChildren"
        ...
        <li *ngIf="!options || options.length === 0" class="disabled" (click)="noMatchClick($event)"><a href="javascript:void(0)">Nenašli sa žiadne výsledky</a></li>
      </ul>
...
export class Behavior {
  ...
  public actor:NgSelect;

  public constructor(actor:NgSelect) {
    this.actor = actor;
  }
